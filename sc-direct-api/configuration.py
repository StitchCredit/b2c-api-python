...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of sc-direct-api.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = sc-direct-api.Configuration(
    ...
    Note you can use the constants defined in the sc-direct-api.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = sc-direct-api.Configuration(
        signing_info = sc-direct-api.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="http://efx-wgt.stitchcredit.com/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("sc-direct-api")
