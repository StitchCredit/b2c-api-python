...
class RedirectViewServletContext(object):
    ...
    def __init__(self, class_loader=None, major_version=None, minor_version=None, init_parameter_names=None, session_cookie_config=None, filter_registrations=None, session_tracking_modes=None, default_session_tracking_modes=None, effective_session_tracking_modes=None, servlet_names=None, server_info=None, servlets=None, session_timeout=None, attribute_names=None, context_path=None, response_character_encoding=None, request_character_encoding=None, jsp_config_descriptor=None, virtual_server_name=None, servlet_registrations=None, effective_major_version=None, effective_minor_version=None, servlet_context_name=None, local_vars_configuration=None):  # noqa: E501
