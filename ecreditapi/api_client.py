...
from ecreditapi import rest
from ecreditapi.configuration import Configuration
from ecreditapi.exceptions import ApiTypeError, ApiValueError, ApiException
from ecreditapi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DirectControllerApi()
        api_instance.change_email  # this is an instance of the class Endpoint
        api_instance.change_email()  # this invokes api_instance.change_email.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.change_email.callable or self.callable in this class
