...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of ecreditapi.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the ecreditapi.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = ecreditapi.Configuration(
        signing_info = ecreditapi.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://efx-wgt.stitchcredit.com/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ecreditapi")
